...
class ClienteComercio {
	...
	List <Usuario> Usuarios;
       ...
       if (System.getSecurityManager() == null)
		...
		case MOSTRAR_TODOS_PEDIDOS:
			...
			for(Usuario usuario_x: Usuarios) {
				verPedidos(usuario_x);	
	System.out.println("-------------------------------------"); 		
				}
										  System.out.println("-----------------------------------------------------------------------------------------"); 
		    }
    ...
    public static void verPedidos(Usuario u){ //Esta función llamará al servidor para que nos devuelva todos los pedidos que tenga el usuario
	int numPedido = 1;
	List <Producto> pro;
	List <Pedido> p;
	p=u.obtenerPedidos();
